...
FILE_PATH = pathlib.Path(
    __file__).parent.parent.parent.parent/'data/simplePhantoms/fanning_2d_3bundles/wm_vf.nii.gz'

test_data = [
    (nib.load(str(FILE_PATH)),
     (np.array([1320, 1321, 1322, 1323, 1324, 1325, 1374, 1375, 1376, 1377, 1378, 1379, 1428, 1429, 1430,
                1431, 1432, 1433, 1482, 1483, 1484, 1485, 1486, 1487, 1536, 1537, 1538, 1539, 1540, 1541,
