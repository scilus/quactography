...
# -------------------------- NO DIFFERENCE BETWEEN THIS FILE AND quactography/visu/dist_prob_node.py FOR NOW ---------------------------------------------------


def plot_distribution_of_probabilities_node(
    in_file, visu_out_file_total, visu_out_file_selected
):

    _, dist_binary_prob, min_cost, h, _, _, _ = load_optimization_results(in_file)
